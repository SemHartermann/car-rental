...
public final class Fields {
	...
	public static final String CAR_DRIVER_PRICE = "driver_price";

	public static final String ORDER_USER_ID = "user_id";
	public static final String ORDER_CAR_ID = "car_id";
	public static final String ORDER_DRIVER_STATUS = "driver_status";
	public static final String ORDER_DATE_START = "start_date";
	public static final String ORDER_DATE_END = "end_date";
	...
	public static final String USER_ORDER_BEAN_DATE_START = "start_date";
	public static final String USER_ORDER_BEAN_DATE_END = "end_date";
	public static final String USER_ORDER_BEAN_ORDER_PRICE = "price";
	...
	public static final String USER_INFO_BEAN_STATUS = "status";
