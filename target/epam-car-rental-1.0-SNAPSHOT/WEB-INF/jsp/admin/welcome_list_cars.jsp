            ...
            <table>
                ...
                <c:forEach var="car" items="${carsList}">
                    <tr>
                        ...
                        <td width="100px" align="center">${car.driverPrice}</td>
                        <td width="100px" align="center">
                            <form action="controller?command=viewUpdateCar" method="post">
                                <input type="hidden" name="carId" value="${car.id}"/>
                                <div class="col">
                                    <input class="btn btn-outline-dark" type="submit" value="<fmt:message
                                            key='update_car.header'/>">
                                </div>
                            </form>
                            <form action="controller?command=deleteCarById" method="post">
                                <input type="hidden" name="id" value="${car.id}"/>
                                <div class="col">
                                    <input class="btn btn-outline-dark" type="submit" value="<fmt:message
                                            key='delete_car.button'/>">
                                </div>
                            </form>
                        </td>
                    </tr>
